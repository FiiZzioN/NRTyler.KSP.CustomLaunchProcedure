...
{
    public sealed class SettingsRepo : IDataContractRepository<ApplicationSettings>, ICrudRepository<ApplicationSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsRepo"/> class.
        /// </summary>
        public SettingsRepo() : this(new ErrorReporter(true))
        {
        ...
        public SettingsRepo(IErrorDialogService errorDialogService)
        {
